...
//
// It sits below `Institute.ContinuousIntegration.Validation` on purpose. A canonical document has two
// consumers that must never disagree: the sweep that *renders* it into a
