...
extension Institute.ContinuousIntegration.Receipt.Bootstrap.Manifest {
    public enum VerificationError: Swift.Error, Sendable, Equatable {
        case identity(Institute.ContinuousIntegration.Receipt.Bootstrap.Identity.ValidationError)
    ...
    public func verify(
        against expected: Institute.ContinuousIntegration.Receipt.Bootstrap.Identity,
        bytes: (String) -> [Byte]?
    ) throws(VerificationError) {
        do throws(Institute.ContinuousIntegration.Receipt.Bootstrap.Identity.ValidationError) {
