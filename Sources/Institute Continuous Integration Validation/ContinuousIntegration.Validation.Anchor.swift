...
extension ContinuousIntegration.Validation {
    ...
    /// `ContinuousIntegration.Inventory.Anchor`. Nothing about
    ...
    public struct Anchor: Validator {
        ...
        public func findings(in subject: Subject) throws(EnvironmentDefect) -> [Finding] {
            ...
            let anchor: ContinuousIntegration.Inventory.Anchor
            do throws(ContinuousIntegration.Inventory.Error) {
...
extension ContinuousIntegration.Validation.Anchor {
    ...
    static func problems(
        regenerating anchor: ContinuousIntegration.Inventory.Anchor,
        over document: GitHub.ContinuousIntegration.Workflow.Document,
        workflow: String
    ) -> [String] {
        var problems: [String] = []
        for source in anchor.sources {
            let checkoutName = ContinuousIntegration.Inventory.Anchor
                .checkoutName(of: source)
            let identityName = ContinuousIntegration.Inventory.Anchor
