...
extension ContinuousIntegration.Inventory {
    ...
    /// (`ContinuousIntegration.Validation.Anchor`), which is
...
extension ContinuousIntegration.Inventory.Anchor {
...
extension ContinuousIntegration.Inventory.Anchor {
    ...
    public init(manifest text: String) throws(ContinuousIntegration.Inventory.Error) {
