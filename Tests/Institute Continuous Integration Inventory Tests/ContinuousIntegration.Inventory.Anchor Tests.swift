...
struct CIInventoryAnchorTests {
    typealias Anchor = ContinuousIntegration.Inventory.Anchor
    ...
    struct Revisions {
        ...
        func `nothing but a canonical object name is accepted`(_ text: String) throws {
            #expect(throws: ContinuousIntegration.Inventory.Error.malformedRevision(text))
            {
    ...
    @Test func `an anchor pinning nothing is refused`() throws {
        #expect(throws: ContinuousIntegration.Inventory.Error.noSources) {
    ...
    @Test func `an unpinned checkout action is refused`() throws {
        #expect(
            throws: ContinuousIntegration.Inventory.Error
